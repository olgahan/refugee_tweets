...
$featurearray = array("Gender" => array("Man","Woman"),"Reason for leaving" => array("Civil war","Invasion","Gang violence","Ethnic or religious persecution","Economic opportunities"),"Military status" => array("Not eligible for military service as a woman","Fit for military service but not conscripted","Fit for military service and conscripted","Not fit for military service"),"Occupation" => array("Farmer","Teacher","Doctor"),"Religion" => array("Christian","Muslim","Agnostic"),"Age" => array("21","38","62"),"English Fluency" => array("None","Broken","Fluent"));

$restrictionarray = array(array(array("Gender","Woman"),array("Military status","Fit for military service but not conscripted")),array(array("Gender","Woman"),array("Military status","Fit for military service and conscripted")),array(array("Gender","Woman"),array("Military status","Not fit for military service")),array(array("Gender","Man"),array("Military status","Not eligible for military service as a woman")));
